...
import { setNumberStat, setVocation } from "../store/actions/currentCharacter";

const EditableVocation = (props: any) => {
  const mode = useSelector((state: RootStateOrAny) => state.mode.mode);
  const [isDarkMode] = useState(mode === "dark" ? true : false);

  var vocation: IVocation = props.item;
...
export default EditableVocation;
